...
def main():
    ...
    parser.add_argument('--train_annotations_file', default='/kaggle/input/MedicalVision/resources/VinXray_train.json', help="Path to training annotations file")
    ...
    parser.add_argument('--valid_annotations_file', default='/kaggle/input/MedicalVision/resources/VinXray_val.json', help="Path to validation annotations file")
    ...
    parser.add_argument('--test_annotations_file', default='/kaggle/input/MedicalVision/resources/VinXray_val.json', help="Path to test annotations file")
